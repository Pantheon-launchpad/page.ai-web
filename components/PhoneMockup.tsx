...
function RingProgress({ percent }: { percent: number }) {
  ...
  return (
    <svg width="64" height="64" viewBox="0 0 64 64" className="shrink-0">
      ...
      />
      <text x="32" y="37" textAnchor="middle" fontSize="15" fontFamily="var(--font-mono)" fill="white">
        {percent}%
      </text>
    </svg>
  );
  ...
  return (
    <div className="theme-fixed-dark relative mx-auto w-full max-w-[320px] select-none px-6 sm:px-10">
      ...
      <div className="relative">
        <TiltCard intensity={7} scale={1.015} className="animate-float rounded-[2.75rem]">
          ...
          <div className="overflow-hidden rounded-[2.1rem] bg-white">
            ...
            <div className="flex items-center justify-between bg-ink px-5 pb-4 pt-4 text-white">
              ...
              <div className="flex items-center gap-1.5 rounded-full bg-white/10 px-2.5 py-1 font-mono text-[10px] uppercase tracking-wider text-white/70">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                  <path d="M2 8.82a15 15 0 0 1 20 0M5 12.86a10 10 0 0 1 14 0M8.5 16.9a5 5 0 0 1 7 0" opacity="0.35" />
            ...
            <div className="space-y-4 bg-ink px-5 pb-6 pt-1 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[15px] font-medium text-white/90">Good morning, Amara</p>
                  <p className="mt-0.5 font-mono text-[11px] text-white/50">Weekly goal</p>
                </div>
            ...
            <div className="space-y-3 px-5 pt-5">
              <p className="font-mono text-[10px] uppercase tracking-wider text-ink-faint">Continue learning</p>
              <div className="flex items-center gap-3 rounded-2xl border border-line bg-paper/70 p-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-[12.5px] font-medium text-ink">Fractions &amp; Decimals</p>
                  <p className="font-mono text-[10px] text-ink-faint">Maths · Lesson 4 of 6</p>
                </div>
              ...
              <p className="pt-1 font-mono text-[10px] uppercase tracking-wider text-ink-faint">My subjects</p>
              <div className="grid grid-cols-2 gap-2.5 pb-6">
                <div className="rounded-2xl border border-line bg-paper/70 p-3">
                  ...
                  <p className="font-mono text-[10px] text-ink-faint">6 lessons offline</p>
                </div>
                <div className="rounded-2xl border border-line bg-paper/70 p-3">
                  ...
                  <p className="font-mono text-[10px] text-ink-faint">4 lessons offline</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* floating "no signal, still working" chip - the signature idea made
            literal. Anchored to the phone device itself (not the outer padded
            wrapper), hanging just off its bottom-right corner so it always
            sits next to the device regardless of viewport width. */}
        <div className="absolute -right-3 bottom-14 z-10 sm:-right-6">
          <div className="glass-card animate-float-sm flex items-center gap-2 rounded-2xl px-3.5 py-2.5 shadow-lift">
            <SignalMark animated />
            <span className="font-mono text-[10px] uppercase tracking-wide text-ink-soft">Full lessons, 0 bars</span>
          </div>
        </div>
      </div>
    </div>
