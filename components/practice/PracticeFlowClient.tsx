    ...
    return (
      <div className="glass-card mx-auto max-w-xl rounded-3xl p-6 sm:p-7">
        ...
        <div className="mt-6 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-ink/10 bg-white/40 p-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-ink/10 bg-white/50 text-ink hover:border-ink/20"
              >
                −
              </button>
