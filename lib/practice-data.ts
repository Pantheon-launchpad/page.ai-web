...
export const questionBank: Question[] = [
  {
    ...
    misconception:
      "It's easy to divide instead of multiply, mixing up the wave equation with the period formula (T = 1/f).",
    memoryHook:
      "Think 'v = f λ' as 'very fast lightning' - speed equals frequency times wavelength.",
    relatedConcepts: [
      "Wave speed formula",
  ...
  },
  {
    ...
    misconception:
      "Students often assume all waves behave like light, since light is the most familiar example.",
    memoryHook:
      "No air, no sound - that's why explosions in space are silent in real physics (not in movies).",
    relatedConcepts: [
  ...
  },
  {
    ...
    misconception:
      "Mixing up 'sharing' (covalent) with 'transferring' (ionic) is the most common slip on this topic.",
    memoryHook:
      "Co-valent = 'co-operating' on electrons, like sharing a textbook between two students.",
  ...
  },
  {
    ...
    difficulty: "easy",
    prompt:
      "As you move across Period 3 from left to right, atomic radius generally:",
    options: [
      "Increases",
      "Decreases",
      "Stays the same",
    ...
    misconception:
      "Some students assume more electrons always means a bigger atom, ignoring the stronger nuclear pull.",
    memoryHook:
      "More protons = stronger pull = tighter hug on the same shell of electrons.",
    relatedConcepts: [
      "Nuclear charge",
  ...
  },
  {
    ...
    misconception:
      "Students sometimes confuse the nucleus (control centre) with the mitochondrion (energy centre).",
    memoryHook:
      "Mito = 'motor' - the organelle that powers everything else the cell does.",
  ...
  },
  {
    ...
    difficulty: "medium",
    prompt:
      "In a monohybrid cross Aa × Aa, what fraction of offspring is expected to be homozygous?",
    ...
    misconception:
      "It's common to only count AA (1/4) and forget aa is homozygous too, missing the full 1/2.",
    memoryHook:
      "Homozygous = 'same letters twice' - count both AA and aa, not just one.",
    relatedConcepts: [
      "Punnett squares",
  ...
  },
  {
    ...
    misconception:
      "Sign errors are the usual trap - forgetting that the factors' sum should equal −(−5) = 5, not −5.",
    memoryHook:
      "Find two numbers that multiply to the last term and add to the middle term's opposite.",
    relatedConcepts: [
      "Factorisation",
  ...
  },
  {
    ...
    misconception:
      "Some students just swap the given fraction (5/3) instead of finding the missing side with Pythagoras.",
    memoryHook:
      "SOH-CAH-TOA - sin gave you opposite/hypotenuse, so build the triangle to get cos from adjacent/hypotenuse.",
    relatedConcepts: [
  ...
  },
  {
    ...
    misconception:
      "It's sometimes confused with 'busy' or 'quick', which don't relate to precision at all.",
    memoryHook:
      "Meticulous sounds like 'metal-ticulous' - as precise and exact as a finely machined metal part.",
    relatedConcepts: [
  ...
  },
  {
    ...
    misconception:
      "Mixing up 'its' (possessive) and 'it's' (it is) is one of the most common grammar slips in English.",
    memoryHook:
      "If you can replace it with 'it is' and the sentence still makes sense, use the apostrophe.",
    relatedConcepts: [
      "Apostrophes",
...
export function questionsFor({
  ...
  return questionBank.filter((q) => {
    ...
    if (difficulty && difficulty !== "adaptive" && q.difficulty !== difficulty)
      return false;
    return true;
  });
}
...
export function topicsFor(subject: string) {
  return Array.from(
    new Set(
      questionBank.filter((q) => q.subject === subject).map((q) => q.topic),
    ),
  );
}
...
export const mockExams: ExamConfig[] = [
  {
    id: "jamb-full-mock",
    title: "JAMB Full Mock - 4 Subjects",
  ...
  {
    id: "waec-trial-sciences",
    title: "WAEC Trial - Sciences",
    subject: "Physics",
    board: "Mock",
    durationMinutes: 50,
    questionCount: 6,
  ...
  {
    id: "waec-trial-arts",
    title: "WAEC Trial - English & Comprehension",
    subject: "English",
    board: "Mock",
    durationMinutes: 40,
    questionCount: 4,
