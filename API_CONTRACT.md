...
*(Architecture prepared; no dedicated UI page consumes this yet.)*
...
*(The shared layer other AI-touching endpoints route through - see the Gemma/LiteRT-LM architecture in the product docs.)*
