        ...
        {weakAreas.map((area) => (
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-3 sm:flex-col sm:items-end sm:gap-2">
              ...
              <Link
                href="/practice"
                className="inline-flex items-center gap-1.5 rounded-full bg-cta px-4 py-2 text-xs font-medium text-cta-text transition-transform hover:-translate-y-0.5 hover:bg-signal-deep"
              >
                Practice this
